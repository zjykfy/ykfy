...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjb3VudHJ5PSJDTiIgJiYgcmVnaW9uPSJCZWlqaW5nIiAmJiBvcmc9IkNoaW5hIFVuaWNvbSBCZWlqaW5nIFByb3ZpbmNlIE5ldHdvcmsiICYmIHBvcnQ9IjQwMDAiICYmIHByb3RvY29sPSJodHRwIg%3D%3D'
# fofa_url = 'http://tonkiang.us/hoteliptv.php?page=1&pv=%E5%8C%97%E4%BA%AC%E8%81%94%E9%80%9A'
...
# 检查视频流的可达性
def check_video_stream_connectivity(ip_port, urls_rtp):
    try:
        # 构造完整的视频URL
        video_url = f"http://{ip_port}{urls_rtp}"
        # 用OpenCV读取视频
...
if unique_ips_ports:
    ...
    valid_ip = None
    for ip_port in unique_ips_ports:
        valid_ip = check_video_stream_connectivity(ip_port, urls_rtp)
        if valid_ip:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/zjykfy/ykfy/main/beijing/beijingzubo.m3u', 'filename': 'beijing/beijingzubo.m3u'},
        ]
