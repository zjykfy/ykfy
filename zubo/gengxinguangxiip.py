...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=Y2l0eT0iR3VpZ2FuZyIgJiYgb3JnPSJDaGluYW5ldCIgJiYgcG9ydD0iODE4MSIgJiYgcHJvdG9jb2w9Imh0dHAi'
...
# 定义组播地址和端口
urls_tsfile = "/tsfile/live/1027_1.m3u8"
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/zjykfy/ykfy/main/guangxi/guangxizubo.m3u', 'filename': 'guangxi/guangxizubo.m3u'},
        ]
