...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjb3VudHJ5PSJDTiIgJiYgcmVnaW9uPSJUaWFuamluIiAmJiBvcmc9IkNISU5BIFVOSUNPTSBDaGluYTE2OSBCYWNrYm9uZSIgJiYgcG9ydD0iODg4OCIgJiYgcHJvdG9jb2w9Imh0dHAi'
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/zjykfy/ykfy/main/tianjin/tianjinzubo.m3u', 'filename': 'tianjin/tianjinzubo.m3u'}
        ]
